...
const getCity = async () => {
  try {
    const result = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url);
...
const viewCity = data => {
  ...
  const getCurrentWeather = async () => {
    ...
    try {
      const Weather = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url);
...
const dailyWeather = async data => {
  ...
  try {
    const daily = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url_daily);
    let res = daily.data;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _axios_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./axios/index */ "./app/axios/index.js");
